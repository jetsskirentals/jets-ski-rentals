            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  { label: 'Signed Waivers', value: bookings.filter(b => b.waiver && b.status !== 'waiver-only').length + waiverSubmissions.length, icon: FileCheck, color: 'text-purple-600 bg-purple-50' },
                ].map(stat => (
